...
// Entité "inverse" (nul besoin d'ajouter une pté de "Advert" ic)
...
class Image
{
  ...
  private $tempFilename; // pour y stocker le nom du fichier temporairement
    ...
    public function setFile(UploadedFile $file = null)
    {
        ...
        if (null !== $this->url) {
            // On sauvegarde l'extension du fichier pr le supprimer plus tard
    ...
    public function preUpload()
    {
        ...
        // Le nom du fichier est son id, on doit stocker =mnt son extension
