<?php
// 1-Entité propriétaire pour "image" (ajout de la propriété "image" ici)
// 2-Entité Inverse pour "Application" (nul besoin de rajouter de pté ici)
// 3-Entité propriétaire pour "Category" (ajouter l'attr "categories")
