...
class Advert
{
     ...
     * @return Advert
     */
    public function addApplication(\OCPlatformBundle\Entity\Application $application)
    {
     ...
     * @param \OCPlatformBundle\Entity\Application $application
     */
    public function removeApplication(\OCPlatformBundle\Entity\Application $application)
    {
